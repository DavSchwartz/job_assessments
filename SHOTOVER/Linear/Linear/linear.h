...
extern "C" LINEAR_API SearchContext * create(const Point * points_begin, const Point * points_end);
...
extern "C" LINEAR_API int32_t search(SearchContext * sc, const Rect rect, const int32_t count, Point * out_points);

/* Release the resources associated with the context. Return nullptr if successful, "sc" otherwise. */
extern "C" LINEAR_API SearchContext * destroy(SearchContext * sc);
